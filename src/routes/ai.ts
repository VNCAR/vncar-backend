    ...
    const model = genAI.getGenerativeModel({
      ...
      generationConfig: {
        ...
        responseSchema: {
          ...
          required: ['pickup', 'dropoff', 'time', 'price', 'carType']
        }
      }
    });

    const systemInstruction = "Bạn là trợ lý ảo cho ứng dụng gọi xe VNCAR. Nhiệm vụ của bạn là trích xuất thông tin chuyến đi từ câu nói của người dùng.";
